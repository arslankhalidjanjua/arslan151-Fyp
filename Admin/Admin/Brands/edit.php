				...
				<div class="tab-pane active" id="tab_0">
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>Edit Brand</div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<?php $product_brand_id=$_GET['id'];
							$result = $conn->prepare("SELECT * FROM product_brand WHERE product_brand_id= :product_brand_id");
							...
							<input type="hidden" name="brandid" value="<?php echo $product_brand_id; ?>" />
								<div class="form-body">
									
									<div class="form-group">
										<label class="col-md-3 control-label">Brand Name<span class="required">*</span></label>
										<div class="col-md-4">
											<input type="text" class="form-control input-circle" name="brandname" value="<?php echo $records['product_brand_name']; ?>"/>
										</div>
									</div>
